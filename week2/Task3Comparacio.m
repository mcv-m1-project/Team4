dirname = 'test';
dirname_new = 'test/mejora';
sA = dir(fullfile([dirname '/A'],'*.png')); % Get all .png files
sB = dir(fullfile([dirname '/B'],'*.png'));
sC = dir(fullfile([dirname '/C'],'*.png'));
sD = dir(fullfile([dirname '/D'],'*.png'));

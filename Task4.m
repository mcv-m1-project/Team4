...
RGB_Specificity = [RGB_A_avg.Specificity, RGB_B_avg.Specificity, RGB_C_avg.Specificity, RGB_D_avg.Specificity, RGB_E_avg.Specificity, RGB_F_avg.Specificity];
RGB_Specificity = mean(RGB_Specificity(:));
...
HSV_Specificity = [HSV_A_avg.Specificity, HSV_B_avg.Specificity, HSV_C_avg.Specificity, HSV_D_avg.Specificity, HSV_E_avg.Specificity, HSV_F_avg.Specificity];
HSV_Specificity = mean(HSV_Specificity(:));
...
Lab_Specificity = [Lab_A_avg.Specificity, Lab_B_avg.Specificity, Lab_C_avg.Specificity, Lab_D_avg.Specificity, Lab_E_avg.Specificity, Lab_F_avg.Specificity];
Lab_Specificity = mean(Lab_Specificity(:));

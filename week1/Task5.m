...
Metodo_RGBLUM_A = TesteigImatges(sA, vA, [dirname '/mask'], [dirname_new '/LUM-A'], 'RGB-LUM');
Metodo_RGBLUM_B = TesteigImatges(sB, vB, [dirname '/mask'], [dirname_new '/LUM-B'], 'RGB-LUM');
Metodo_RGBLUM_C = TesteigImatges(sC, vC, [dirname '/mask'], [dirname_new '/LUM-C'], 'RGB-LUM');
Metodo_RGBLUM_D = TesteigImatges(sD, vD, [dirname '/mask'], [dirname_new '/LUM-D'], 'RGB-LUM');
Metodo_RGBLUM_E = TesteigImatges(sE, vE, [dirname '/mask'], [dirname_new '/LUM-E'], 'RGB-LUM');
Metodo_RGBLUM_F = TesteigImatges(sF, vF, [dirname '/mask'], [dirname_new '/LUM-F'], 'RGB-LUM');

function createValidationMasktest(struct, dirname, dirname_new, pixel_method)
    ...
    for i = 1:j
        im = imread(fullfile([dirname], struct(i).name));
        toSplit = strsplit(struct(i).name,{'.jpg'}); %struct{i}.name
        switch pixel_method
	...
	case 'RGB'
            ...
            imwrite(mask_rgb, strjoin([dirname_new '/mask.' toSplit(1) '.RGB.png'],''));
	...
	case 'HSV'
            ...
            imwrite(mask_hsv, strjoin([dirname_new '/mask.' toSplit(1) '.HSV.png'],''));
        ...
        case 'Lab'
            ...
            imwrite(mask_lab, strjoin([dirname_new '/mask.' toSplit(1) '.LAB.png'],''));
        ...
        case 'RGB-LUM'
            ...
            imwrite(mask_rgb, strjoin([dirname_new '/mask.' toSplit(1) '.RGB-LUM.png'],''));

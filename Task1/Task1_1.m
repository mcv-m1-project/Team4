...
for k = 1:length(txtFiles)
  ...
  if length(data{5})<=1                  %per saber si hi ha una senyal o més al arxiu que hem llegit, mirem la llargada de c{5} (tipus de senyal)
        ...
        cantidadsenales=length(data{5});   %si hi han més d'una imatge per arxiu entro en aquesta part.
